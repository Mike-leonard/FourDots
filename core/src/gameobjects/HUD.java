...
public class HUD extends GameObject {
    ...
    public HUD(GameWorld world, float x, float y, float width, float height,
        ...
        scoreText = new Text(world, x, y, width, height, AssetLoader.square,
                world.parseColor(Settings.BACK_RECTANGLE_HUD_COLOR,1f), Configuration.SCORE_TEXT + world.getScore(), AssetLoader.fontS,
        ...
        bestText = new Text(world, x, y, width, height, AssetLoader.square,
                ...
                AssetLoader.fontS, world.parseColor(Settings.BEST_HUD_COLOR,1f), Settings.HUD_TEXT_Y_DISTANCE, Align.right);
    ...
    public void start() {
        effectY(world.gameHeight, world.gameHeight - getSprite().getHeight(), .4f, .9f);
    }
